<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adlogin.aspx.cs" Inherits="campus1.adlogin" %>
...
<body>
   ...
   <div id="top">
                   ...
                   <tr>
                       <td valign="top" width="250">
                           ...
                           <table class="style1">
                               ...
                               <tr>
                                   <td>
                                       <asp:HyperLink ID="HyperLink2" runat="server" ForeColor="#66CCFF" NavigateUrl="~/newadmin.aspx">New Admin</asp:HyperLink>
                                   </td>
                               </tr>
                               <tr>
                                   <td>
                    ...
                    ImageUrl="~/img/icem12.jpg" Width="668px" EnableTheming="True" /> &nbsp;</td>
                               </tr>
                           </table>
                       </td>
                       <td valign="top" width="250">
    ...
    <div id="foot" dir="rtl">&nbsp;.........<b>WELCOME TO ADMIN LOGIN PAGE</b>..........</div>
