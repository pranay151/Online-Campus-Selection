<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="studlogin.aspx.cs" Inherits="campus1.studlogin" %>
...
<body>
   ...
   <div id="top">
                   ...
                   <tr>
                       <td valign="top" width="250">
                           ...
                           <table class="style1">
                               ...
                               <tr>
                                   <td>
                                       <asp:HyperLink ID="HyperLink2" runat="server" ForeColor="#66CCFF" NavigateUrl="~/newstudent.aspx">New Student</asp:HyperLink>
                                   </td>
                               </tr>
                               <tr>
                                   <td>
                           ...
                           <table align="center" class="style1">
                               ...
                               <tr>
                                   <td>
                                       &nbsp;</td>
                                   <td align="center" class="style4">
                                       <asp:Button ID="Button1" runat="server" CssClass="btn" Text="Login" OnClick="Button1_Click1" />
                                   </td>
                                   <td>
                                       &nbsp;</td>
                               </tr>
                    ...
                    ImageUrl="~/img/ss.jpg" Width="668px" EnableTheming="True" /> &nbsp;</td>
                               </tr>
                           </table>
                       </td>
                       <td valign="top" width="250">
    ...
    <div id="foot" dir="rtl">&nbsp;.........<b>WELCOME TO STUDENT LOGIN PAGE</b>..........</div>
